...
class DecoderA(nn.Module):
    ...
    def forward(self, h):
        ...
        x = F.elu(self.fc2(self.ln2(x)))
        x = F.softmax(self.fc3(self.ln3(x)), dim=1)
        return x
...
scheduler_A = StepLR(optimizer_A, step_size=350, gamma=0.5)
...
torch.save(EncoderG.state_dict(), 'ENG.pth')
torch.save(DecoderA.state_dict(), 'DEA.pth')
